...
const loginUserCtrl = asyncHandler(async (req, res) => {
  ...
  if (findUser && (await findUser.isPasswordMatched(password))) {
    ...
    res.status(200).json({
      ...
      bname: findUser?.bname,
      blname : findUser?.blname,
...
const loginAdmin = asyncHandler(async (req, res) => {
  ...
  if (findAdmin && (await findAdmin.isPasswordMatched(password))) {
    ...
    res.json({
      ...
      fax:  findAdmin?.fax,
      website : findAdmin?.website,
      timezone : findAdmin?.timezone,
      bname: findAdmin?.bname,
      blname : findAdmin?.blname,
...
//   // const Data = geoLocation({_id,la})
//  if (isValidLocation(location)) {
//     // Perform the login action here
//     console.log('Logged in successfully');
//  } else {
//     console.log('Failed to log in: Invalid location');
//  }
// }
...
//     const geolocationResponse = await axios.get('https://freegeoip.app/json/${ipAddress}');
//     const latitude = geolocationResponse.data.latitude;
//     const longitude = geolocationResponse.data.longitude;
